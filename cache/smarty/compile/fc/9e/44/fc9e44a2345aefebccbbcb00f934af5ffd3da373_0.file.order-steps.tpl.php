...
/* Smarty version 3.1.39, created on 2022-06-08 07:06:50
  from '/var/app/current/themes/hotel-reservation-theme/order-steps.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_62a04a8a894412_11823983',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fc9e44a2345aefebccbbcb00f934af5ffd3da373' => 
    array (
      0 => '/var/app/current/themes/hotel-reservation-theme/order-steps.tpl',
      1 => 1654583688,
      2 => 'file',
    ),
  ),
...
function content_62a04a8a894412_11823983 (Smarty_Internal_Template $_smarty_tpl) {
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,NULL,((string)$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'url_back'))."&step=1".$_prefixVariable44), ENT_QUOTES, 'UTF-8', true);?>
">
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,NULL,((string)$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'url_back'))."&step=1".$_prefixVariable45), ENT_QUOTES, 'UTF-8', true);?>
">
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,NULL,((string)$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'url_back'))."&step=2".$_prefixVariable46), ENT_QUOTES, 'UTF-8', true);?>
">
