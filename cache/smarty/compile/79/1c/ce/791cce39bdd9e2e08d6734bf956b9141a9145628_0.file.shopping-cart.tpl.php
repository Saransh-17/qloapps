...
/* Smarty version 3.1.39, created on 2022-06-08 07:06:51
  from '/var/app/current/themes/hotel-reservation-theme/shopping-cart.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_62a04a8bbc5b97_01235754',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '791cce39bdd9e2e08d6734bf956b9141a9145628' => 
    array (
      0 => '/var/app/current/themes/hotel-reservation-theme/shopping-cart.tpl',
      1 => 1654583688,
      2 => 'file',
    ),
  ),
...
function content_62a04a8bbc5b97_01235754 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/app/current/tools/smarty/plugins/modifier.date_format.php','function'=>'smarty_modifier_date_format',),1=>array('file'=>'/var/app/current/tools/smarty/plugins/modifier.regex_replace.php','function'=>'smarty_modifier_regex_replace',),));
?>
...
$_smarty_tpl->_assignInScope('total_discounts_num', $_prefixVariable62);?>
	<?php ob_start();
...
$_smarty_tpl->_assignInScope('use_show_taxes', $_prefixVariable63);?>
	<?php ob_start();
...
$_smarty_tpl->_assignInScope('total_wrapping_taxes_num', $_prefixVariable64);?>
...
if ($_prefixVariable65 <= 9) {?>0<?php echo $_smarty_tpl->tpl_vars['rm_v']->value['num_rm'];
} else {
echo $_smarty_tpl->tpl_vars['rm_v']->value['num_rm'];
}?>
								</p>
...
if ($_prefixVariable66 <= 9) {?>0<?php echo $_smarty_tpl->tpl_vars['data_v']->value['adult'];
} else {
echo $_smarty_tpl->tpl_vars['data_v']->value['adult'];
...
if ($_prefixVariable67 <= 9) {?>0<?php echo $_smarty_tpl->tpl_vars['data_v']->value['children'];
} else {
echo $_smarty_tpl->tpl_vars['data_v']->value['children'];
...
$__foreach_address_225_saved = $_smarty_tpl->tpl_vars['address'];
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
				...
				<?php
$_smarty_tpl->tpl_vars['address'] = $__foreach_address_225_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			<?php }?>
		</div>
