...
/* Smarty version 3.1.39, created on 2022-06-08 07:06:52
  from '/var/app/current/admin/themes/default/template/invalid_token.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_62a04a8c43ba39_09336962',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '91bd4fcdf442f3d42a7f9443954d45d09626f236' => 
    array (
      0 => '/var/app/current/admin/themes/default/template/invalid_token.tpl',
      1 => 1654583688,
      2 => 'file',
    ),
  ),
...
function content_62a04a8c43ba39_09336962 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html>
	<head>
		<meta charset="UTF-8">
		<title><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Invalid security token'),$_smarty_tpl ) );?>
</title>
		<style>
			body{
	...
	<body>
		<div class="container">
			<div class="error-msg">
				...
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Invalid security token'),$_smarty_tpl ) );?>

			</div>
			<div class="action-container">
				<a class="btn btn-continue" href="<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'I understand the risks and I really want to display this page'),$_smarty_tpl ) );?>

				</a>
				<a class="btn btn-cancel" href="index.php">
					<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Take me out of here!'),$_smarty_tpl ) );?>
