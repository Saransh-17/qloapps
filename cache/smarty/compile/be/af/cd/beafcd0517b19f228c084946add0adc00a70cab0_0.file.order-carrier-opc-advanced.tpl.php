...
/* Smarty version 3.1.39, created on 2022-06-08 07:06:49
  from '/var/app/current/themes/hotel-reservation-theme/order-carrier-opc-advanced.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_62a04a89b800e4_92138692',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'beafcd0517b19f228c084946add0adc00a70cab0' => 
    array (
      0 => '/var/app/current/themes/hotel-reservation-theme/order-carrier-opc-advanced.tpl',
      1 => 1654583688,
      2 => 'file',
    ),
  ),
...
function content_62a04a89b800e4_92138692 (Smarty_Internal_Template $_smarty_tpl) {
...
$__foreach_option_138_saved = $_smarty_tpl->tpl_vars['option'];
?>
...
$__foreach_carrier_139_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
...
"/>
                                                        ...
                                                        <?php }?>
                                                    <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_139_saved;
}
...
$_smarty_tpl->tpl_vars['carrier']->iteration++;
$_smarty_tpl->tpl_vars['carrier']->last = $_smarty_tpl->tpl_vars['carrier']->iteration === $_smarty_tpl->tpl_vars['carrier']->total;
$__foreach_carrier_140_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
                                                        ...
                                                        <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_140_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
$__foreach_product_141_saved = $_smarty_tpl->tpl_vars['product'];
?>
...
if (!$_smarty_tpl->tpl_vars['product']->last) {?>,&nbsp;<?php } else { ?>)<?php }
                                                            ...
                                                            <?php
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_141_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                        <?php }?>
                                                    </td>
...
$_smarty_tpl->tpl_vars['carrier']->iteration++;
$_smarty_tpl->tpl_vars['carrier']->last = $_smarty_tpl->tpl_vars['carrier']->iteration === $_smarty_tpl->tpl_vars['carrier']->total;
$__foreach_carrier_142_saved = $_smarty_tpl->tpl_vars['carrier'];
?>
...
$_smarty_tpl->tpl_vars['product']->index++;
$_smarty_tpl->tpl_vars['product']->last = $_smarty_tpl->tpl_vars['product']->iteration === $_smarty_tpl->tpl_vars['product']->total;
$__foreach_product_143_saved = $_smarty_tpl->tpl_vars['product'];
?>
                                                                        <?php if ($_smarty_tpl->tpl_vars['product']->index == 4) {?>
                                                                            <acronym title="
                                                                        <?php }?>
...
if (!$_smarty_tpl->tpl_vars['product']->last) {?>,&nbsp;<?php } else { ?>)<?php }
                                                                    ...
                                                                    <?php
$_smarty_tpl->tpl_vars['product'] = $__foreach_product_143_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                                                <?php }?>
                                                            </td>
                                                    ...
                                                    <?php }?>
                                                <?php
$_smarty_tpl->tpl_vars['carrier'] = $__foreach_carrier_142_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                            </table>
                                        <?php }?>
                            ...
                            <?php
$_smarty_tpl->tpl_vars['option'] = $__foreach_option_138_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
...
$__foreach_address_144_saved = $_smarty_tpl->tpl_vars['address'];
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                ...
                                <?php }?>
                                <?php
$_smarty_tpl->tpl_vars['address'] = $__foreach_address_144_saved;
}
